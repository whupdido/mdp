...
def _simulation_motion_model() -> MotionModel:
    ...
    return MotionModel(
        primitives=(
            ...
            MotionPrimitive("FL", Gear.FORWARD, Steering.LEFT, turn_angle_rad=quarter_turn, radius_cm=27.7, estimated_duration_s=2.4),
            MotionPrimitive("FR", Gear.FORWARD, Steering.RIGHT, turn_angle_rad=-quarter_turn, radius_cm=36.5, estimated_duration_s=2.9),
            MotionPrimitive("BL", Gear.REVERSE, Steering.LEFT, turn_angle_rad=-quarter_turn, radius_cm=28.1, estimated_duration_s=2.3),
            MotionPrimitive("BR", Gear.REVERSE, Steering.RIGHT, turn_angle_rad=quarter_turn, radius_cm=38.3, estimated_duration_s=2.8),
        ),
